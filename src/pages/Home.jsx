    ...
    return (
        <main className="bg-black text-white">
            ...
            <section className="font-unbounded hero flex flex-col items-center justify-center text-center py-12 bg-gradient-to-b from-black via-black to-red-600 min-h-screen relative overflow-hidden">
                <div className="content relative z-10 max-w-2xl mt-[-350px]">
                    <h1 className="text-6xl mb-4 font-light font-Unbounded">Tem sempre um <br />Prêmio para você</h1>
                    <p className="mb-6 text-lg font-Montserrat">Diversos prêmios à sua disposição</p>
